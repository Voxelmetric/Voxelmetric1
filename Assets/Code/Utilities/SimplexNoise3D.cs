...
public class SimplexNoise3D {
	...
	public SimplexNoise3D(string seed) {
		T = new int[8];
	...
	public SimplexNoise3D(int[] seed) { // {0x16, 0x38, 0x32, 0x2c, 0x0d, 0x13, 0x07, 0x2a}
		T = seed;
	}
	...
	public float CoherentNoise(float x, float y, float z, int octaves=2, int multiplier = 25, float amplitude = 0.5f, float lacunarity = 2, float persistence = 0.9f) {
