...
public class wildgrassOverride : BlockOverride
{
    ...
    {
        block.data2 = (byte)(64 + ((chunk.world.noiseGen.Generate(pos.x * 100, pos.y * 100, pos.z * 100) + 1) * 96));
        int offset1 = (int)((chunk.world.noiseGen.Generate(pos.x* 100, pos.y* 100, pos.z * 100) + 1) * 16);
        block.data3 = (byte)((block.data3 & 240) | (offset1 & 15));
        int offset2 = (int)((chunk.world.noiseGen.Generate(pos.x*100, pos.y * 100 + 1000, pos.z * 100) + 1) * 16);
